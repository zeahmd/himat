...
while True:
    ...
    save_image(image[0], f'output/{img_name}_0.png', nrow=1, normalize=True, value_range=(-1, 1))
    save_image(image[1], f'output/{img_name}_1.png', nrow=1, normalize=True, value_range=(-1, 1))
    save_image(image[2], f'output/{img_name}_2.png', nrow=1, normalize=True, value_range=(-1, 1))